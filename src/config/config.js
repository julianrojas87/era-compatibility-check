...
export const ERA_VOCABULARY = 'http://era.ilabt.imec.be/vocabulary';
export const ERA_VEHICLES = 'http://era.ilabt.imec.be/vehicles';
export const ABSTRACTION_TILES = 'http://era.ilabt.imec.be/sparql-tiles/abstraction';
